...
class Player(Bot):
    ...
    def handle_round_over(self, game_state, terminal_state, active):
        ...
        if (opp_bid and opp_bid < self.min_opp_bid):
        ...
        if self.early_game: # loose passive
            ...
            if street == 3:
                ...
                if BidAction in legal_actions:
                    ...
                    return BidAction(int(random.random()*my_stack) * 0.5)
            ...
            if CheckAction in legal_actions:
                return CheckAction()
            if BidAction in legal_actions:
                return BidAction(min(my_stack, self.min_opp_bid))
            return FoldAction()
